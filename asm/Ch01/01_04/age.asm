; input: read a age and sum ten years and show
; initialized data
section .data
	prompt		db		"Enter your age: ",0
    outputmsg   db      "Your age in ten years is: ",0
	newline		db		10			; \n
...
; sum 10 year in rax
    add     rax, 10                 ; sum 10 years

; convert the value in rbx to a string	
	mov		rbx, rax				; get looping value for count
	mov		rsi, value
	call	binary2decimal			; convert rbx into decimal at rsi

; output the message
	mov		rsi, outputmsg 			; output the message
	call	print_string
